...
const MainContent = () => {
  ...
  return (
    <div className='relative'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {loadingProjects ? (
            Array.from({ length: 5 }).map((_, idx) => (
              <div key={idx} className="animate-pulse bg-white rounded-lg shadow-md overflow-hidden h-64 p-4 flex flex-col justify-center items-center">
                <div className="bg-gray-300 w-full h-32 mb-4 rounded-md"></div>
      ...
      <div id='testimonials' className="py-20 px-4 md:px-16 bg-white">
        <div className="text-center mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {loadingClients ? (
            Array.from({ length: 5 }).map((_, idx) => (
              <div key={idx} className="animate-pulse bg-white rounded-lg shadow-md p-4 h-72 flex flex-col justify-center items-center">
                <div className="w-12 h-12 bg-gray-300 rounded-full mb-7"></div>
                <div className="bg-gray-300 h-4 w-3/4 mb-2 rounded"></div>
                <div className="bg-gray-200 h-3 w-1/2 rounded"></div>
              </div>
            ))
